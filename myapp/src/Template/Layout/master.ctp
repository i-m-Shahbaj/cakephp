...
<?php $this->html->css('library/bootstrap.min.css') ?>
<?php $this->html->css('library/bootstrap-responsive.min.css') ?>
<?php $this->html->css('library/fullcalendar.css') ?>
<?php $this->html->css('maruti-media.css') ?>
</head>
<body>
...
<?php $this->html->js('library/excanvas.min.js') ?>
<?php $this->html->js('library/jquery.min.js') ?>
<?php $this->html->js('library/jquery.ui.custom.js') ?>
<?php $this->html->js('library/bootstrap.min.js') ?>
<?php $this->html->js('library/jquery.flot.min.js') ?>
<?php $this->html->js('library/jquery.flot.resize.min.js') ?>
<?php $this->html->js('library/jquery.peity.min.js') ?>
<?php $this->html->js('library/fullcalendar.min.js') ?>
<?php $this->html->js('maruti.js') ?>
<?php $this->html->js('maruti.dashboard.js') ?>
<?php $this->html->js('maruti.chat.js') ?>
